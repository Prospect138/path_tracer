...
static point3 k_position{0.0, 5.0, 0.0};

int main()
{
    Sphere sphere0{{10.0, -5.0, 12.0}, {0.00, 0.74, 0.4}, 3.5, 0.6};
    Sphere sphere1{{1.45, -1.0, 12.0}, {0.77, 0.03, 0.1}, 3.5, 0.1};
    Sphere sphere2{{-8.4, -3.0, 12.0}, {0.04, 0.23, 0.70}, 3.5, 0.9};
    Sphere sphere4{{-16.7, -6.0, 12.0}, {0.03, 0.23, 0.8}, 3.5, 0.0};
